...
{
    public partial class PreviousApps : Page, IIniContext
    {
      ...
      //  public List<string> GetSectionNames()
       // {            return iniSections?.Keys.ToList() ?? new List<string>();        }
        ...
        {
            return iniSections.ContainsKey(section)
                ? new Dictionary<string, string>(iniSections[section])
