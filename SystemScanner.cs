...
namespace PackageConsole
{
    ...
    public static class SystemScanner
    {
        ...
        public static string GenerateHtmlReport(SystemSnapshot before, SystemSnapshot after)
        {
            ...
            string logsDir = @"C:\Temp\AppTesting\Reports\SystemScannerLogs";
        ...
        {
            string logDir = @"C:\Temp\AppTesting\Reports\SystemScannerLogs";
            Directory.CreateDirectory(logDir);
            string path = Path.Combine(logDir, $"snapshot_{tag}_{DateTime.Now:yyyyMMdd_HHmmss}.json");
