...
namespace PackageConsole
{
    public partial class AppDeploymentTestPage : Page
    {
        ...
        private const string PackageArchivePath = @"\\SankaraSubrahmanyam-PC\D$\Package_Archive";
        private const string CompletedPackagesPath = @"\\SankaraSubrahmanyam-PC\D$\Completed_Packages";
        ...
        private void btnBrowse_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (rbPackageArchive.IsChecked == true)
                basePath = @"\\SankaraSubrahmanyam-PC\D$\Package_Archive";
            else if (rbCompletedPackages.IsChecked == true)
                basePath = @"\\SankaraSubrahmanyam-PC\D$\Completed_Pacakges";
        ...
        private bool RunDeploymentSafe()
        {
            try
            {
                ...
                if (deployType == "MSI" || deployType == "MSI + MST")
                {
                    ...
                    destinationFolder = Path.Combine(@"C:\Temp\AppTesting", $"{appName}_{appVersion}");
                }
                else if (deployType == "PSADTK")
                {
                    ...
                    destinationFolder = Path.Combine(@"C:\Temp\AppTesting", $"{appName}_{appVer}");
                }
